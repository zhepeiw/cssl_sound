...
class SimCLR(sb.core.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        # Embeddings
        h1 = self.modules.projector(self.modules.embedding_model(x1))  # [B, 1, D]
        h2 = self.modules.projector(self.modules.embedding_model(x2))  # [B, 1, D]
        z1 = self.modules.predictor(h1)  # [B, 1, D]
        z2 = self.modules.predictor(h2)  # [B, 1, D]

        return z1, z2, h1, h2, lens
    ...
    def compute_objectives(self, predictions, batch, stage):
        z1, z2, h1, h2, lens = predictions
        loss = self.hparams.compute_simclr_cost(z1.squeeze(), z2.squeeze())
